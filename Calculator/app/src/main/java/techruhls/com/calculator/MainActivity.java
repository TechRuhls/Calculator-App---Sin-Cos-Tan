package techruhls.com.calculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSIN.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    doubleValue = Math.sin(Math.toRadians(doubleValue));
        ...
        buttonCOS.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Double doubleValue = Double.parseDouble(value);
                    doubleValue = Math.cos(Math.toRadians(doubleValue));
                    result.setText(doubleValue.toString());
                } catch (NumberFormatException e) {
                    newNumber.setText("");
                }
        ...
        buttonTAN.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Double doubleValue = Double.parseDouble(value);
                    doubleValue = Math.tan(Math.toRadians(doubleValue));
                    result.setText(doubleValue.toString());
                } catch (NumberFormatException e) {
                    newNumber.setText("");
                }
